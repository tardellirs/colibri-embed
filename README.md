...
[![MTEB(por)](https://img.shields.io/badge/MTEB(por)-0.6501-1f6feb)](https://huggingface.co/spaces/mteb/leaderboard)
...
> Evaluated on **[MTEB(por)](https://huggingface.co/spaces/mteb/leaderboard)** — 22 native Brazilian-Portuguese tasks
...
supported this work, and the **[MTEB(por)](https://huggingface.co/spaces/mteb/leaderboard)** benchmark maintainers.
